...
export const TierTwoBubble = ({ project }) => {
  ...
  return (
    <Link
      to={project.linkPath}
      className="tier-two-bubble-link"
      style={bubbleLinkStyles}
    >
      <div className="tier-two-bubble" style={tierTwoBubbleStyles}>
        ...
        <img
          alt="tier two project bubble icon"
          src={project.icon}
          className="tier-two-icon"
        />
      </div>
    </Link>
  );
