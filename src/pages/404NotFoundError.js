    ...
    <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div className="flex flex-col items-center max-w-sm mx-auto text-center">
            ...
            <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                ...
                <button onClick={() => navigate(-1)} className="flex items-center justify-center w-1/2 px-5 py-2 text-sm transition-colors duration-200 border rounded-lg gap-x-2 sm:w-auto hover:bg-gray-100 text-base-content bg-base-300">
                ...
                <button className="w-1/2 px-5 py-2 text-sm border tracking-wide text-primary-content transition-colors duration-200 rounded-lg shrink-0 sm:w-auto hover:bg-primary-content hover:text-primary bg-primary">
                    Take me home
                </button>
                </Link>
            </div>
