...
export default function RDSPage() {
    const overview = "A project that solved a unique problem statment for my General Engineering & Prototyping course. Winner of Nick Russo Award for Outstanding General Engineering Design.";
...
<PageContainerOutline className="site-page">
      ...
      >
        <p>
                Problem prompt: <i>A blackout has occurred in New York City. Three hospitals have used up their backup power supplies due to the unanticipated duration of the blackout. There are some power supply areas in the city with fuel cells that supply enough power for the hospitals' need. In order to save lives, Mayor Bill de Blasio has issued an RFP for a robot that can retrieve and deliver fuel cells accumulating a minimum of 200 hours of reserve energy.</i>
            </p>
            <p>
                <i>Your robot must be able to navigate the course autonomously around the city and retrieve fuel cells and deliver them to hospitals, in less than 5 minutes. You must design the product with the tools given (Lego Mindstorms, Lego Digital Designer, Autodesk Fusion360, etc).</i>
            </p>
            <p>For the project we separated our roles  to efficiently accomplish tasks and finish on time. I was the Project Coordinator, and was in charge of keeping our progress on track and making sure all the requirements were met. We were a team of a Head Builder, Director of Software, and Project Coordinator. Together, we were RCC Builders and Developers, and our robot’s name was Poppy. 
            </p>
            <p>To plan out the schedule of the project I used Microsoft Project and made the template myself. I also made the cost estimate table for our project, so that we could demonstrate that our robot design was not only efficient but also cost effective.
            </p>
      ...
      >
       <p>
            ...
            <iframe width="960" height="515" src="https://www.youtube.com/embed/K-kFgggJ1Ag"  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe>
            </div>
